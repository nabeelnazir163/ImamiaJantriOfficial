...
public class SplashActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(cursor.getCount() != 0)
        {
            ...
            if(crntMonth > Integer.valueOf(monthfromDb))
            {
                setNamazTimes();
            }
        }
    ...
    private void setNamazTimes() {
        ...
        //Url of API
        prayer_url = "http://api.aladhan.com/v1/calendar?latitude=" + (lat) + "&longitude=" + (lng) + "&method=1&month=" + calMonth + "&year=" + calYear;
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (response != null) {
                        ...
                        dbHelper.PutNamazTimeInformation(dbHelper, response);
...
//                    finish();
    ...
    private void setNextMonthNamazTimes() {
        ...
        //Url of API
        prayer_url_2 = "http://api.aladhan.com/v1/calendar?latitude=" + (lat) + "&longitude=" + (lng) + "&method=1&month=" + calMonth + "&year=" + calYear;
